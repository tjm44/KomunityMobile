...
const styles = StyleSheet.create({
    ...
    infoText: { fontSize: 14, color: '#3730a3', lineHeight: 20, fontFamily: 'Outfit-Regular' },
    createButton: {
    ...
    kycButton: { backgroundColor: '#4338ca', borderRadius: 12, paddingVertical: 14, paddingHorizontal: 24, alignItems: 'center', width: '100%', marginBottom: 12 },
